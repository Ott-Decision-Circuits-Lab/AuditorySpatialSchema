...
GoalChoice = SessionData.Custom.TrialData.GoalChoice(1:nTrials);
if isempty(GoalChoice) || all(isnan(GoalChoice))
...
TrialDataTable = table(TrialRewardProb', EarlyWithdrawal', NoDecision', StartNewTrial',...
                       ...
                       GoalChoice', SampleTime',MoveTime',...
...
LRTrialDataTable = table(double(GoalChoice'==5), NoDecision', NotBaited',...
...
TrialLeftMoveTimeLine = line(TrialLRMoveTimeAxes,...
                             'xdata', idxTrial(GoalChoice==1),...
                             'ydata', MoveTime(GoalChoice==1),...
                             'LineStyle', 'none',...
                             'Marker', '.',...
                             'MarkerEdge', sand);

TrialRightMoveTimeLine = line(TrialLRMoveTimeAxes,...
                              'xdata', idxTrial(GoalChoice==5),...
                              'ydata', MoveTime(GoalChoice==5),...
                              'LineStyle', 'none',...
                              'Marker', '.',...
...
TrialLeftTILine = line(TrialLRTIAxes,...
                       'xdata', idxTrial(NotBaited & GoalChoice==1),...
                       'ydata', FeedbackWaitingTime(NotBaited==1 & GoalChoice==1),...
                       'LineStyle', 'none',...
                       'Marker', '.',...
                       'MarkerEdge', sand);

TrialRightTILine = line(TrialLRTIAxes,...
                        'xdata', idxTrial(NotBaited==1 & GoalChoice==5),...
                        'ydata', FeedbackWaitingTime(NotBaited==1 & GoalChoice==5),...
                        'LineStyle', 'none',...
                        'Marker', '.',...
                        'MarkerEdge', turquoise);
...
switch SessionData.SettingsFile.GUIMeta.RiskType.String{SessionData.SettingsFile.GUI.RiskType}
    ...
    case 'Cued' % currently only designed for 1-arm
        ...
        %% Dedicated Analysis script and figure saving for Matching
        %AnalysisFigure = AuditorySpatialSchema_Cued();
